/* Synthetic, deterministic data for the Mal BI Lead case study. No customer or bank data is used. */
const BI_DATA = {
  asOf: '31 Jul 2026',
  ...
  kpis: [
    {label:'Certified active customers', value:'18,640', delta:'+7.1% QoQ', trend:'good', domain:'Enterprise', status:'Certified', note:'Enterprise Active Customer · KPI-01'},
    {label:'Net revenue', value:'AED 6.42m', delta:'+10.3% MoM', trend:'good', domain:'Finance', status:'Certified', note:'Revenue, net of incentives · KPI-04'},
    {label:'Savings balance', value:'AED 94.8m', delta:'+6.3% MoM', trend:'good', domain:'Finance', status:'Certified', note:'Closing customer deposits · KPI-05'},
    {label:'Gross loan book', value:'AED 142.6m', delta:'+1.8% MoM', trend:'good', domain:'Credit', status:'Certified', note:'Principal outstanding · KPI-09'},
    {label:'Approval rate', value:'61.8%', delta:'+1.2pp vs floor', trend:'good', domain:'Credit', status:'Certified', note:'Final approvals / adjudicated · KPI-07'},
    {label:'PAR30', value:'2.4%', delta:'−0.2pp YoY', trend:'good', domain:'Risk', status:'Certified', note:'30+ DPD principal / GLB · KPI-10'},
    {label:'Digital activation', value:'74.6%', delta:'+2.9pp QoQ', trend:'good', domain:'Product', status:'Certified', note:'Activated in 7 days · KPI-13'},
    {label:'Early delinquency', value:'2.8%', delta:'+0.3pp MoM', trend:'warn', domain:'Risk', status:'Exploratory', note:'New-to-Credit segment · KPI-12'}
  ],
  ...
  metrics: [
    ...
    ['KPI-18 · Data Freshness SLA','Enterprise','BI Lead','Share of certified data products refreshed by their published SLA.','on_time_certified_marts / certified_marts','bi_observability_daily','Daily 07:00 GST','Certified'],
    ['KPI-19 · Data Quality Pass Rate','Enterprise','BI Lead','Share of active critical data quality tests passing on the latest successful refresh.','passing_critical_tests / critical_tests_run','bi_observability_daily','Daily 07:00 GST','Certified']
  ]
};
